#!/bin/bash
# =============================================================================
# kubuntu-desktop-setup.sh — Kubuntu 26.04 Desktop Setup
# =============================================================================
# Ausgangslage: Kubuntu 26.04 Minimal Install
# Umfang: Snap-Purge, i386, Nvidia 595+ Open (CUDA 2404 Repo),
#         NTSYNC, Fish, Starship, Fastfetch, Firefox (Mozilla PPA),
#         Kubuntu Restricted Extras, Steam, ProtonPlus, Faugus,
...
[[ $EUID -ne 0 ]] && err "Bitte als root ausführen: sudo bash kubuntu-desktop-setup.sh"
...
echo "  ╚═╝  ╚═╝ ╚═════╝ ╚═════╝  ╚═════╝ ╚═╝  ╚═══╝   ╚═╝    ╚═════╝ "
echo -e "${NC}"
echo -e "  ${BOLD}Kubuntu 26.04 — Desktop Setup${NC}"
...
snap remove --purge snap-store firmware-updater \
    snapd-desktop-integration 2>/dev/null || true
snap remove --purge gtk-common-themes plasma-welcome bare 2>/dev/null || true
...
info "Kubuntu Restricted Extras installieren..."
